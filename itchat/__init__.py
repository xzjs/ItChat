...
__client = client()
def auto_login(hotReload = False, statusStorageDir = 'itchat.pkl', enableCmdQR = True):
    if hotReload:
...
def get_QR(uuid = None, enableCmdQR = True): return __client.get_QR(uuid, enableCmdQR)
